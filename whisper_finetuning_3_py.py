...
login(token="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")
...
common_voice["train"] = load_dataset("mozilla-foundation/common_voice_11_0", "fa", split="train+validation", trust_remote_code=True)
